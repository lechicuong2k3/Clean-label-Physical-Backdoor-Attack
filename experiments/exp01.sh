...
python main.py --trigger=real_beard --recipe=label-consistent --poisonkey=1-0 --alpha=0.1 --beta=0.0 --scenario=finetuning  --threatmodel=clean-multi-source 
python main.py --trigger=sunglasses --recipe=label-consistent --poisonkey=1-3 --alpha=0.1 --beta=0.0 --scenario=finetuning  --threatmodel=clean-multi-source 
python main.py --trigger=red_headband --recipe=label-consistent --poisonkey=1-4 --alpha=0.1 --beta=0.0 --scenario=finetuning  --threatmodel=clean-multi-source 