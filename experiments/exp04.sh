...
# torchrun --standalone --rdzv-endpoint=localhost:21212 --nnodes=1 --nproc-per-node=2 main_dist.py --trigger=red_headband --recipe=hidden-trigger --poisonkey=0-2 --alpha=0.5 --beta=0.0 --scenario=finetuning  --threatmodel=clean-single-source 
# torchrun --standalone --rdzv-endpoint=localhost:21212 --nnodes=1 --nproc-per-node=2 main_dist.py --trigger=red_headband --recipe=hidden-trigger --poisonkey=6-2 --alpha=0.5 --beta=0.0 --scenario=finetuning  --threatmodel=clean-single-source 
# torchrun --standalone --rdzv-endpoint=localhost:21212 --nnodes=1 --nproc-per-node=2 main_dist.py --trigger=red_headband --recipe=hidden-trigger --poisonkey=9-2 --alpha=0.5 --beta=0.0 --scenario=finetuning  --threatmodel=clean-single-source 
