import numpy as np
import torch
import source.defenses.cleansers.robust_estimation as robust_estimation
...
def cleanser(inspection_set, model, num_classes, args, oracle_clean_set=None):
    ...
    if oracle_clean_set is not None:
        clean_feats, clean_class_indices = get_features(oracle_clean_set, model, num_classes)
