...
def cleanser(inspection_set, clean_set, model, num_classes, args):
    feats_inspection, class_indices_inspection = get_features(inspection_set, model, args.model, args.save_rep_path)
    feats_clean, class_indices_clean = get_features(clean_set, model, args.model, args.save_rep_path)
