...
if ('gradient-matching' not in args.recipe) and ('hidden-trigger' not in args.recipe):
    ...
    args.output = f'outputs/defense/{args.recipe}/{args.scenario}/{args.trigger}/{args.net[0]}/{target}_{args.scenario}_{args.trigger}_{args.alpha}_{args.beta}_{args.attackoptim}.txt'   
else:
    args.output = f'outputs/defense/{args.recipe}/{args.scenario}/{args.trigger}/{args.net[0]}/{args.poisonkey}_{args.scenario}_{args.trigger}_{args.alpha}_{args.beta}_{args.attackoptim}.txt'
